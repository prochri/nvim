...
mappings["w"]["."] = { "<cmd>lua prochri.hydra.window:activate()<cr>", "Window hydra" }
...
mappings["o"]["t"] = { "<cmd>lua prochri.open_todays_note()<cr>", "Open todays note" }
mappings["o"]["b"] = { "<cmd>ZkBacklinks<cr>", "Show Backlinks" }
mappings["o"]["p"] = { "<cmd>lua prochri.open_pdf()<cr>", "Open PDF file under cursor" }
...
mappings["d"]["."] = { "<cmd>lua prochri.hydra.debug:activate()<cr>", "debug hydra" }
