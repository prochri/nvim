...
map("n", "<leader>ot", "<cmd>lua prochri.open_todays_note()<cr>", {noremap = true, silent = true, desc = "Open todays note"})
map("v", "<leader>ot", "<cmd>lua prochri.open_todays_note()<cr>", {noremap = true, silent = true, desc = "Open todays note"})
