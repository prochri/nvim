...
map("n", "<leader>bb", "<cmd>lua Snacks.picker.buffers()<cr>", {noremap = true, silent = true, desc = "search buffers"})
map("v", "<leader>bb", "<cmd>lua Snacks.picker.buffers()<cr>", {noremap = true, silent = true, desc = "search buffers"})
...
map("n", "<leader>ff", "<cmd>lua Snacks.picker.files()<cr>", {noremap = true, silent = true, desc = "find files"})
map("v", "<leader>ff", "<cmd>lua Snacks.picker.files()<cr>", {noremap = true, silent = true, desc = "find files"})
...
map("n", "<leader>pf", "<cmd>lua Snacks.picker.smart()<cr>", {noremap = true, silent = true, desc = "Files in git project"})
map("v", "<leader>pf", "<cmd>lua Snacks.picker.smart()<cr>", {noremap = true, silent = true, desc = "Files in git project"})
...
map("n", "<leader>ptt", "<cmd>OverseerTaskAction<cr>", {noremap = true, silent = true, desc = "Search tasks and actions"})
map("v", "<leader>ptt", "<cmd>OverseerTaskAction<cr>", {noremap = true, silent = true, desc = "Search tasks and actions"})
map("n", "<leader>ptw", "<cmd>OverseerToggle<cr>", {noremap = true, silent = true, desc = "Toggle Task Window"})
map("v", "<leader>ptw", "<cmd>OverseerToggle<cr>", {noremap = true, silent = true, desc = "Toggle Task Window"})
map("n", "<leader>ptc", "<cmd>OverseerRunCmd<cr>", {noremap = true, silent = true, desc = "Create a task"})
map("v", "<leader>ptc", "<cmd>OverseerRunCmd<cr>", {noremap = true, silent = true, desc = "Create a task"})
...
map("n", "<leader>gd", "<cmd>DiffviewOpen<cr>", {noremap = true, silent = true, desc = "GitDiff"})
map("v", "<leader>gd", "<cmd>DiffviewOpen<cr>", {noremap = true, silent = true, desc = "GitDiff"})
map("n", "<leader>sp", "<cmd>Telescope egrepify<cr>", {noremap = true, silent = true, desc = "Search project"})
map("v", "<leader>sp", "<cmd>Telescope egrepify<cr>", {noremap = true, silent = true, desc = "Search project"})
map("n", "<leader>sP", "<cmd>lua Snacks.picker.grep_word()<cr>", {noremap = true, silent = true, desc = "Search string in project"})
map("v", "<leader>sP", "<cmd>lua Snacks.picker.grep_word()<cr>", {noremap = true, silent = true, desc = "Search string in project"})
...
map("n", "<leader>td", "<cmd>tabclose<cr>", {noremap = true, silent = true, desc = "Tab delete"})
map("v", "<leader>td", "<cmd>tabclose<cr>", {noremap = true, silent = true, desc = "Tab delete"})
map("n", "<leader>tc", "<cmd>tabnew<cr>", {noremap = true, silent = true, desc = "Tab create"})
map("v", "<leader>tc", "<cmd>tabnew<cr>", {noremap = true, silent = true, desc = "Tab create"})
map("n", "<leader>tn", "<cmd>tabnext<cr>", {noremap = true, silent = true, desc = "Next tab"})
map("v", "<leader>tn", "<cmd>tabnext<cr>", {noremap = true, silent = true, desc = "Next tab"})
map("n", "<leader>tp", "<cmd>tabprevious<cr>", {noremap = true, silent = true, desc = "Previous tab"})
map("v", "<leader>tp", "<cmd>tabprevious<cr>", {noremap = true, silent = true, desc = "Previous tab"})
