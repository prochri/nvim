...
table.insert(_G.prochri.wk_map, { "<leader>v", group = "+vimtex" })
...
map(
  "n",
  "<leader>ci",
  "<cmd>lua prochri.code_action_import()<cr>",
  { noremap = true, silent = true, desc = "Import under cursor" }
)
map(
  "v",
  "<leader>ci",
...
table.insert(_G.prochri.wk_map, { "<leader>w", group = "+Window" })
...
map(
  "n",
  "<leader>w.",
  "<cmd>lua prochri.hydra.window:activate()<cr>",
  { noremap = true, silent = true, desc = "Window hydra" }
)
map(
  "v",
  "<leader>w.",
...
table.insert(_G.prochri.wk_map, { "<leader>f", group = "+Files" })
...
map("n", "<leader>fs", "<cmd>silent! w!<cr>", { noremap = true, silent = true, desc = "save" })
map("v", "<leader>fs", "<cmd>silent! w!<cr>", { noremap = true, silent = true, desc = "save" })
map("n", "<leader>fS", "<cmd>silent! wa!<cr>", { noremap = true, silent = true, desc = "save all" })
map("v", "<leader>fS", "<cmd>silent! wa!<cr>", { noremap = true, silent = true, desc = "save all" })
...
map(
  "n",
  "<leader>pn",
  "<cmd>!open -n /Applications/Neovide.app<cr>",
  { noremap = true, silent = true, desc = "New (Neovide) Project Window" }
)
map(
  "v",
  "<leader>pn",
...
map(
  ...
  { noremap = true, silent = true, desc = "Files in git project" }
)
map(
  "v",
  "<leader>pf",
...
map(
  ...
  "<leader>pr",
  "<cmd>OverseerRun<cr>",
  { noremap = true, silent = true, desc = "Run project task from template" }
)
map(
  "v",
  "<leader>pr",
...
table.insert(_G.prochri.wk_map, { "<leader>pt", group = "+Task Tools" })
...
map(
  "n",
  "<leader>pto",
  "<cmd>OverseerQuickAction open<cr>",
  { noremap = true, silent = true, desc = "Last Task Actions" }
)
map(
  "v",
  "<leader>pto",
...
table.insert(_G.prochri.wk_map, { "<leader>o", group = "+Organizational/Obsidian" })
...
map(
  "n",
  "<leader>op",
  "<cmd>lua prochri.open_pdf()<cr>",
  { noremap = true, silent = true, desc = "Open PDF file under cursor" }
)
map(
  "v",
  "<leader>op",
...
map(
  ...
  { noremap = true, silent = true, desc = "Search string in project" }
)
map(
  "v",
  "<leader>sP",
...
table.insert(_G.prochri.wk_map, { "<leader>t", group = "+Toggles" })
...
map(
  "n",
  "<leader>td",
  "<cmd>lua prochri.dapui.toggle()<cr>",
...
map(
  ...
  { noremap = true, silent = true, desc = "Toggle LSP lines" }
)
map(
  "v",
  "<leader>tl",
...
map(
  "n",
  "<leader>d.",
  "<cmd>lua prochri.hydra.debug:activate()<cr>",
  { noremap = true, silent = true, desc = "debug hydra" }
)
map(
  "v",
  "<leader>d.",
...
map(
  ...
  { noremap = true, silent = true, desc = "start debugging" }
)
map(
  "v",
  "<leader>dd",
...
map(
  ...
  "<leader>dr",
  "<cmd>lua require'dap'.continue()<cr>",
  { noremap = true, silent = true, desc = "start (without) debugging" }
)
map(
  "v",
  "<leader>dr",
...
table.insert(_G.prochri.wk_map, { "<leader>e", group = "+Error" })
map(
  "n",
  "<leader>en",
...
map(
  ...
  { noremap = true, silent = true, desc = "List errors in Trouble" }
)
map(
  "v",
  "<leader>el",
...
map(
  "n",
  "<leader>ey",
  "<cmd>lua prochri.yank_diagnostic()<cr>",
  { noremap = true, silent = true, desc = "Yank first error" }
)
map(
  "v",
  "<leader>ey",
...
table.insert(_G.prochri.wk_map, { "<leader>q", group = "+Quickfix" })
